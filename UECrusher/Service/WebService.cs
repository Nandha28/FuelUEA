...
namespace Utilities
{
    public class WebService
    {
        ...
        public string GetDataFromWebService(string subURL)
        {
        ...
        public string PostDataToWebService(string method, string deviceID, string siteId)
        {
            ...
            return Between(response.Content, "<GetVEResult>", "</GetVEResult>");
        }
